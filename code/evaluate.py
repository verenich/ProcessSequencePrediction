'''
this script takes as input the LSTM weights found by train.py
change the path in line 172 of this script to point to the h5 file
with LSTM weights generated by train.py
...
model = load_model('output_files/models/model_33-1.51.h5')
